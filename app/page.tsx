...
function FloatingSilhouettes() {
  return (
    <div className="home-silos" aria-hidden="true">
      <svg className="silo s1" aria-hidden="true" viewBox="0 0 40 32">
        <g fill="#00f5ff">
      ...
      <svg className="silo s2" aria-hidden="true" viewBox="0 0 32 32">
        <g fill="#ff006e">
      ...
      <svg className="silo s3" aria-hidden="true" viewBox="0 0 32 32">
        <g fill="#f5ff00">
      ...
      <svg className="silo s4" aria-hidden="true" viewBox="0 0 24 24">
        <g fill="#00ff88">
      ...
      <svg className="silo s5" aria-hidden="true" viewBox="0 0 36 24">
        <g fill="#aa00ff">
      ...
      <svg className="silo s6" aria-hidden="true" viewBox="0 0 20 20">
        <g fill="#ffcf3a">
      ...
      <svg className="silo s7" aria-hidden="true" viewBox="0 0 24 22">
        <g fill="#ff3060">
      ...
      <svg className="silo s8" aria-hidden="true" viewBox="0 0 24 24">
        <g fill="#00d4ff">
...
function FeatureIcon({ kind }: { kind: "GAMEPAD" | "FREE" | "TROPHY" | "ROCKET" }) {
  ...
  if (kind === "GAMEPAD")
    return (
      <svg className="ft-icon" aria-hidden="true" viewBox="0 0 16 16">
        <g fill={C}>
